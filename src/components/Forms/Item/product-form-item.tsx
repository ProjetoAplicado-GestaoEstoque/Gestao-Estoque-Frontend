                    ...
                    <div>
                        ...
                        <p>
                            {projects.find((p) => p.id === item.project_id)
                                ? `${projects.find((p) => p.name)} - ${projects.find((p) => p.instituition)} (ID: ${item.project_id})`
                                : 'Não selecionado'}
                        </p>
                    </div>
                    <div>
                        ...
                        <p>
                            {item.supplier_id
                                ? `${suppliers.find((s) => s.corporate_name)} (${suppliers.find((s) => s.cnpj)})`
                                : 'Não selecionado'}
                        </p>
                    </div>
                </div>
